...
class map_edit_gui{
    public:
        map_edit_gui(ros::NodeHandle& nh, ros::NodeHandle& pnh);
        ~map_edit_gui();
    private:
        ros::NodeHandle nh_;
        ros::NodeHandle pnh_;
...
map_edit_gui::map_edit_gui(ros::NodeHandle& nh, ros::NodeHandle& pnh){
    nh_ = nh;
    pnh_ = pnh;
    ...
    pcl_rviz_selected_clusters_sub_ = nh_.subscribe("rviz_selected_clusters", 2, &map_edit_gui::cbRvizSelectedClusters, this);
    pcl_rviz_selected_points_sub_ = nh_.subscribe("rviz_selected_points", 2, &map_edit_gui::cbRvizSelectedPoints, this);
    pcl_ros_sub_ = nh_.subscribe("mapcloud", 2, &map_edit_gui::cbMapcloud, this);
    rviz_clusters_keyboard_sub_ = nh_.subscribe("rviz_selected_clusters_key", 2, &map_edit_gui::cbKeyBoardClusters, this);
    rviz_points_keyboard_sub_ = nh_.subscribe("rviz_selected_points_key", 2, &map_edit_gui::cbKeyBoardPoints, this);
...
map_edit_gui::~map_edit_gui(){

}

void map_edit_gui::funcQueueOperation(){
...
void map_edit_gui::updateSelectedCluster(){
...
void map_edit_gui::pubCurrentRemainingPC(){
...
void map_edit_gui::funcRemoveWalls(){ 
...
void map_edit_gui::funcLastStep(){
...
void map_edit_gui::funcDeleteSelectedClusters(){
...
void map_edit_gui::funcDeleteAggregatedPoints(){
...
void map_edit_gui::funcPatchPlanar(){
...
void map_edit_gui::cbKeyBoardPoints(const std_msgs::String::ConstPtr& msg){
...
void map_edit_gui::cbKeyBoardClusters(const std_msgs::String::ConstPtr& msg){
...
void map_edit_gui::funcResetClusters(){
...
void map_edit_gui::cbRvizSelectedPoints(const sensor_msgs::PointCloud2::ConstPtr& msg){
...
void map_edit_gui::cbRvizSelectedClusters(const sensor_msgs::PointCloud2::ConstPtr& msg){
...
void map_edit_gui::cbMapcloud(const sensor_msgs::PointCloud2::ConstPtr& msg)
{
...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "map_edit_gui_node");


  ros::NodeHandle nh_;
  ros::NodeHandle pnh_("~");
  map_edit_gui GED = map_edit_gui(nh_,pnh_);
